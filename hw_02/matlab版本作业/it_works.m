...
%%need to change file name from "it_works" to "A_star_search"
%This part is about map/obstacle/and other settings
    ...
    path_cost=0;
    cost=goal_distance+path_cost;
    % 将一个节点的信息插入到OPEN list队尾
    OPEN(OPEN_COUNT,:)=insert_open(xNode,yNode,xNode,yNode,goal_distance,path_cost,cost);
